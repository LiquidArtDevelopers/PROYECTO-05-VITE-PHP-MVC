...
<head>
    ...
    <?php
    // Metadatos globales
    include __DIR__ . '/../../includes/eu/metadatos_globales.php'
    ?>
...
<body>
    ...
    include __DIR__ . '/../../includes/eu/body_global.php'
    ?>

    <!-- NAV -->
    <?php include __DIR__ . '/../../includes/eu/nav.php' ?>
    ...
    <header>        
        ...
        ?>
            <article class="artForm">
                <form action="/App/app/gestionFormLogin.php" method="post">
    ...
    <!-- FOOTER -->
    <?php include __DIR__ . '/../../includes/eu/footer.php'?>
